import { Dialog, DialogActions, DialogContent, FormControl, FormGroup, Checkbox, FormControlLabel, Button, DialogTitle } from "@mui/material"
import { useSelector, useDispatch } from "react-redux"

import { toggleSelected } from "../actions"


export const ColumnsController = (props) => {
    ...
    return <Dialog open={props.open} onKeyDown={handleListKeyDown}>
