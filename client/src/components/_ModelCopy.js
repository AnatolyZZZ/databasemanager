...
import {
  InputLabel, Select, FormControl, MenuItem, Stack, Button, TextField, DialogTitle,
} from '@mui/material';
import { useState, useEffect, useCallback } from 'react';
import {
  chooseModel, chooseVersion, setNewTableRows, ACTIONS,
  openNewRow, setEditMode, setNewTableToDefault, validationErrors,
} from '../actions';
